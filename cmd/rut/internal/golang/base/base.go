...
// Package base defines shared basic pieces of the rut command.
package base
...
// A Command is an implementation of a rut command.
type Command struct {
	...
	// Short is the short description shown in the 'rut help' output.
	Short string

	// Long is the long message shown in the 'rut help <this-command>' output.
	Long string
	...
	// The order here is the order in which they are printed by 'rut help'.
...
func (c *Command) LongName() string {
	...
	return strings.TrimPrefix(name, "rut ")
}
...
func (c *Command) Usage() {
	...
	fmt.Fprintf(os.Stderr, "Run 'rut help %s' for details.\n", c.LongName())
	SetExitStatus(2)
	Exit()
}
